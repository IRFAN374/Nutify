...
const Auth = () => {
    ...
    const [messageInfo, setMessageInfo] =useState( useSelector((state)=>state.auth.messageInfo));
    ...
    const handleSubmitForm =(event)=>{
        ...
        if(isSignUp){
           ...
           console.log("i am signIn Called")
    ...
    return (
        <Container component="main" maxWidth="xs">
          <Paper elevation={3} className={classes.paper}>
            ...
            {messageInfo && <SnackBarMessage setMessageInfo={setMessageInfo} messageInfo={messageInfo} />}
            <form className={classes.form} onSubmit={handleSubmitForm}>
               <Grid container spacing={2}>
                ...
                <GoogleLogin 
                  ...
                  render={(renderProps)=>( <Button color="secondary" fullWidth variant="contained" className={classes.googleButton} onClick={renderProps.onClick} startIcon={<Icon/>} > Google Sign In </Button> )}
